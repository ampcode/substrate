...
func buildDeploymentApplyConfig(wp *atev1alpha1.WorkerPool, otel ateomOTelSettings, systemNamespace, ateletServiceAccount, routerServiceAccount string, pki workerPKISettings) *appsv1ac.DeploymentApplyConfiguration {
